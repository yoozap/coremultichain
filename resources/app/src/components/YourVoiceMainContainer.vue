      ...
      <div class="container">
        <div class="main-container__description" data-aos="fade-up">
          ...
          <div class="content_description">
            Your feedback is invaluable to us. It helps to improve our product
            and your experience with us – that's why we incentivize users who
            provide us useful feedback through this form.
          </div>
        </div>
      </div>
    </div>
    <div class="container feedback-form" data-aos="fade-up">
      <el-form ref="ruleForm" :model="ruleForm" :rules="rules">
        <el-form-item label="Email" prop="email">
          <el-input type="email" v-model="ruleForm.email" placeholder="Enter">
          </el-input>
        </el-form-item>
        ...
        <transition name="fade">
          <div class="success-msg" v-if="success">
            ...
            <p class="success-text">
              The request was successfully sent. We'll take a close look at it.
              Thank you!
            </p>
            <div class="close-btn" @click="resetForm">Close message</div>
          </div>
        </transition>
      </el-form>
    </div>
